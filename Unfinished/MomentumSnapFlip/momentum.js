...
/* SETTINGS */
var i_v = {
    i_touchlistener     : '.img-container',         // element to monitor for touches, set to null to use document. Otherwise use quotes. Eg. '.myElement'. Note: if the finger leaves this listener while still touching, movement is stopped.
    i_scrollElement     : '.img-container',         // element (class) to be scrolled on touch movement
    ...
    i_handleY           : false,                     // should scroller handle vertical movement on element?
